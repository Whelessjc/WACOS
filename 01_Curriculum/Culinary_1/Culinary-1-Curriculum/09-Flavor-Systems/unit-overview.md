...
- I can taste safely and adjust in small steps.
...
|---|---|
| Flavor system | Ingredients and techniques that work together to build flavor. |
| Salt | Seasoning that makes flavor clearer. |
| Acid | Sour ingredient that brightens or balances food. |
| Aromatics | Ingredients that build smell and flavor. |
| Balance | Flavors working together without one taking over. |
| Adjust | Make a small change after tasting. |

## Lab Applications
- Salt/acid/fat tasting
- Aromatic base comparison
- Soy and ginger
- Vinegar and herbs
- Chili and citrus
- Yogurt and spice
...
## Assessment Ideas
- Tasting notes
- Flavor comparison reflection
- Seasoning adjustment observation
- Aromatic base check
