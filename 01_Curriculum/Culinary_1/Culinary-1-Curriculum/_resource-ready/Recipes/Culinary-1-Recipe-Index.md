...
## Pancakes
- **Unit connection:** Unit 01
- **Skill focus:** recipe reading, measuring, mise en place, teamwork, heat awareness
- **Approximate difficulty:** Beginner
- **Equipment needed:** mixing bowls, measuring tools, whisk/spoon, griddle or pan, turner
- **Food safety concern:** handwashing, shared tools, hot surface
- **Cleanup/reset concern:** sticky batter, hot pan, dishes, counters, floors
- **Possible Bistro connection:** First low-stakes lab for station setup and reset
- **Notes for future recipe development:** Use teacher-approved pancake mix or recipe; exact formula still needed.

## Brownie Batter
- **Unit connection:** Unit 02
...
## Chicken Breast Temperature Lab
- **Unit connection:** Unit 02
- **Skill focus:** thermometer use, time/temperature, evidence-based doneness
- **Approximate difficulty:** Beginner/controlled
- **Equipment needed:** thermometers, sanitizer, gloves as directed, cutting boards, pans
- **Food safety concern:** raw poultry, probe cleaning, cross contamination
- **Cleanup/reset concern:** raw-contact surfaces, thermometers, boards, storage
- **Possible Bistro connection:** Builds guest-safety habits for later protein and Bistro work
- **Notes for future recipe development:** Use district-approved temperature guidance and teacher-selected product.
...
## Rice Cookery
- **Unit connection:** Unit 03
- **Skill focus:** liquid ratios, timing, texture, patience
- **Approximate difficulty:** Beginner
- **Equipment needed:** pot or rice cooker, measuring cups, lid, spoon
- **Food safety concern:** steam burns, hot pot, storage
- **Cleanup/reset concern:** starchy pot, counter spills, storage
- **Possible Bistro connection:** Useful base for fried rice or Bistro bowls
- **Notes for future recipe development:** Exact ratio may vary by rice type and equipment.
...
- **Skill focus:** grip, claw, board setup, cut size, product use
- **Approximate difficulty:** Beginner
- **Equipment needed:** knives, boards, towels, containers, compost/trash
- **Food safety concern:** knife safety, stable boards
- **Cleanup/reset concern:** boards, knives, product sorting, floors
- **Possible Bistro connection:** Prepares vegetables for Bistro prep or later labs
- **Notes for future recipe development:** Use low-cost vegetables and plan how product will be used.

## Sauteed Vegetables
- **Unit connection:** Unit 06/07
- **Skill focus:** knife cuts, pan preheat, oil control, timing
- **Approximate difficulty:** Beginner/medium
- **Equipment needed:** skillet, tongs/spatula, knife setup
- **Food safety concern:** hot pan, oil, steam
- **Cleanup/reset concern:** oily pans, counters, floors
- **Possible Bistro connection:** Potential Bistro side or prep practice
- **Notes for future recipe development:** Exact vegetables depend on availability.
...
## Roasted Vegetables
- **Unit connection:** Unit 06/07
- **Skill focus:** cut size, oven spacing, browning, texture
- **Approximate difficulty:** Beginner/medium
- **Equipment needed:** sheet pans, oven, parchment if used, spatula
- **Food safety concern:** hot oven, hot pans
- **Cleanup/reset concern:** sheet pans, oily surfaces, floors
- **Possible Bistro connection:** Bistro side or batch prep practice
- **Notes for future recipe development:** Exact vegetables, temp, and seasoning need teacher selection.

## Potato Batonnet
- **Unit connection:** Unit 06/08
- **Skill focus:** knife control, even cut size, fryer prep
- **Approximate difficulty:** Medium
- **Equipment needed:** knives, boards, water bowl if used, towels
- **Food safety concern:** knife safety, wet product near fryer later
- **Cleanup/reset concern:** starch, wet towels, boards
- **Possible Bistro connection:** Prep skill for fries or Bistro side
- **Notes for future recipe development:** Exact size standard should be teacher-approved.

## Fries
- **Unit connection:** Unit 08
- **Skill focus:** oil safety, batch size, draining, seasoning timing
- **Approximate difficulty:** Medium
- **Equipment needed:** fryer or pot system if approved, spider/tongs, rack, tray
- **Food safety concern:** hot oil, water near oil, crowding
- **Cleanup/reset concern:** greasy tools, oil station, floors
- **Possible Bistro connection:** Bistro side only if fryer policy allows
- **Notes for future recipe development:** Do not finalize until local fryer/oil policy is confirmed.
...
## Onion Rings or Similar Low-Cost Frying Application
- **Unit connection:** Unit 08
...
- **Approximate difficulty:** Medium
- **Equipment needed:** pans, thermometers, tongs, boards, sanitizer
- **Food safety concern:** raw poultry, thermometer use, cross contamination
...
- **Unit connection:** Unit 10
- **Skill focus:** safe handling, browning, seasoning, doneness
- **Approximate difficulty:** Medium
- **Equipment needed:** skillet, spatula, thermometer if used, sanitizer
- **Food safety concern:** raw poultry, cross contamination
- **Cleanup/reset concern:** raw tools, greasy pan, storage
- **Possible Bistro connection:** Can support Bistro bowl, taco, or sauce prep if approved
- **Notes for future recipe development:** Exact application should match available menu/cost.
...
## Final Skill Inventory or Readiness Task
- **Unit connection:** Unit 11
- **Skill focus:** self-assessment, prep list, limited ownership, reset
- **Approximate difficulty:** Beginner
- **Equipment needed:** teacher-selected tools/materials
- **Food safety concern:** depends on selected task
- **Cleanup/reset concern:** final reset, storage, shared spaces
- **Possible Bistro connection:** Shows service ownership and Culinary 2 readiness
- **Notes for future recipe development:** Not a recipe; use evidence from labs, service, and stewardship.
