...
| File | Purpose |
|---|---|
| `WACOS_Style_Guide.md` | Establishes consistent voice, terminology, capitalization, naming, and writing standards for West Ashley Culinary documents and communications |
| `WACOS_Playbook.md` | Translates the Core Manual into daily and weekly operating routines for instruction, Kitchen Mode, Bistro prep, Bistro service, grading evidence, leadership, reset, and review |
| `WACOS_AI_Reference.md` | Provides a short AI-facing reference for ChatGPT, Codex, custom GPTs, and future AI assistants, including source hierarchy, guardrails, and reusable prompts |
| `WACOS_Custom_Instructions_Draft.md` | Distills program context and response guidance into concise instructions suitable for a dedicated ChatGPT account |

## Quality Screen Applied

The documents were checked against the WACOS Alignment Checklist for:
...
- Avoidance of unnecessary educational jargon.

## Unresolved Questions

The following items still need instructor confirmation in future subordinate documents:

- Exact definition and classroom implementation of Kitchen Mode beyond the routine label used here.
