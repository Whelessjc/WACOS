...
| Bistro Operating Philosophy | `05_Bistro_Operations.md`, `08_Daily_and_Weekly_Systems.md`, `13_Templates_Checklists.md`, `2026-07-20_Calendar_Week_Mapping.md`, instructor decisions | Elevated Bistro to central instructional model; retained Thursday prep/Friday service and mapped the 2026-2027 launch to Week 4 systems work and Week 5 normal public service |
| Assessment Philosophy | `06_Assessment_System.md`, `03_Assessment/Tools/`, current orientation materials, instructor confirmations dated 2026-07-19, 2026-07-23, and 2026-08-06 | Adopted current 45% Summative Assessments: Projects, Tests, and Bistro; 35% Formative Assessments and Labs; 20% Employability Skills; established concise Bistro, lab, and Employability observation records with natural checkpoints, exception-based notes, repeated evidence, and instructor judgment |
...
| Daily Teaching Guides | `Professional_Thinking_Framework.md`, `08_Daily_and_Weekly_Systems.md`, `09_Workflows/Daily_Teaching_Guide_Standard.md`, instructor-confirmed flex-mod schedule dated 2026-07-24 | Established the operational layer between curriculum and instruction, including Core/Flexible Learning, equivalent weekly learning, first-ten-day elasticity, and path/PACK assignments |
