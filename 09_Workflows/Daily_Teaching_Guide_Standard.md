...
2. **Required supporting systems:** the cumulative routines students must combine, such as Kitchen Mode, **Notebook. Pen. Plan. workflow readiness**, communication, sanitation, Equipment Literacy, mise en place, workflow, clean-as-you-go, and reset.
...
The first ten days require the most elastic DTGs. Homeroom, official enrollment counts, IDs, schedule corrections, late arrivals, and enrollment changes may reduce or interrupt class time. The first day is usually the least predictable; conditions progressively improve, and students may be added or dropped through Day 10.

During this period:

- Plan a short Core Learning sequence that can stand alone.
- Make repeated orientation and re-entry possible without restarting the whole class.
- Keep student handouts practical and easy to replace.
