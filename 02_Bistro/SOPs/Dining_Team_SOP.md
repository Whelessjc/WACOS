# Dining Team SOP (Host, Server, Runner/Busser)

Current as of 2026-08-26. Source: real Server Side Work Checklist and current Bistro operating decisions. See `Service_Standards.md` for the greet/serve/clear/guest-recovery standards this team applies during service.
...
- Confirm the current menu/specials are posted; know what can be accurately communicated to a guest.
- Turn on the Bistro neon light and prepare the guest-order area.
...
- Close/store Square/order devices only as directed.
- Students do not perform final cash/check reconciliation or deposit delivery.
- Report guest issues, shortages, or equipment problems to the instructor.
- Leave Dining ready for the next service.
