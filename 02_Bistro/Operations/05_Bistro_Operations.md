...
## Launch Model
The Bistro should open only after students have practiced safety, sanitation, dish systems, menu knowledge, roles, stocking, life of an order, and mock service. Sources point to a launch window around Week 4-6 depending on course, calendar, and student readiness. Version 2.1 standardizes this as a readiness-based launch window rather than a fixed week.

## Life of an Order
1. Guests check in and receive a number.
2. Guests are seated.
3. Their number is called to place the order.
4. The order is fired in the kitchen.
5. Kitchen, expo, and FOH coordinate the handoff.
6. Guest issues are handled calmly and reported.
7. Tables, dishes, and stations reset.

## Role Rotations
| Area | Example Roles |
|---|---|
| BOH | Prep, hot line, cold station, baking, dish, stewarding, expeditor |
| FOH | Host, order support, runner, busser, barista/beverage, customer service |
| Support | Stocking, labels, laundry, trash, sanitizer, smallwares, menu support |
| Leadership | Bistro manager, station lead, sanitation lead, inventory assistant |
...
- Complete station closing checklist.
